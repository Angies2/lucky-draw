<template>
  <div class="baberrage-stage" v-show="isShow" ref="stage">
    <div class="baberrage-top">
      <VueBaberrageMsg v-for="item in topQueue" v-bind:key="item.userId" class="baberrage-item" :item="item" />
    </div>
    <!-- Normal -->
    <VueBaberrageMsg v-for="item in normalQueue" v-bind:key="item.userId" class="baberrage-item" :item="item" />
    <div class="baberrage-bottom">
      <VueBaberrageMsg v-for="item in bottomQueue" v-bind:key="item.userId" class="baberrage-item" :item="item" />
    </div>
  </div>
</template>
<script>
import VueBaberrageMsg from './component/vue-baberrage-msg'
import { MESSAGE_TYPE } from './component/constants.js'
